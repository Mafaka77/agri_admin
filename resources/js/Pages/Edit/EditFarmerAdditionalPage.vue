                ...
                <form @submit.prevent="submit" method="POST">
                    ...
                    <div class="row justify-around q-pt-md">
                        ...
                        <div class="col-xs-12 col-md-5">
                            ...
                            <q-file
                                :display-value="form.ration_card_path"
                                ...
                                <div class="row justify-around q-gutter-y-md">
                                    <div class="col-xs-12 col-md-5">
                                        <q-select v-model="scheme.availed" :options="avialedList" dense
                                                  option-label="label" option-value="value" stack-label :model-value="scheme.availed===1?'Yes':scheme.availed===0?'No':scheme.availed==='Yes'?'Yes':'No'"
                                    ...
                                    <div class="col-xs-12 col-md-5">
                                        <q-input
                                            :disable="scheme.availed===0||scheme.availed==='No'"
                                            name="benefit_amount"
                                            outlined
                    ...
                    <div class="row justify-around">
                        <div class="col-xs-12 col-md-5">
                            <q-file
                                :display-value="form.aadhaar_card_path"
                        ...
                        <div class="col-xs-12 col-md-5">
                            <q-file
                                :display-value="form.bank_passbook_path"
...
const form=useForm({
    ...
    scheme_id:'',
    schemeApplied:props.additional.scheme_applied,
    is_kcc_availed:props.additional.is_kcc_availed==1?'Yes':'No',
    kcc_card_no:props.additional.kcc_card_no,
    kcc_renew_or_new:props.additional.kcc_renew_or_new,
    bank_name:props.additional.bank_name,
    branch_name:props.additional.branch_name,
    year_of_amount_sanction:props.additional.year_of_amount_sanction,
    amount_sanction:props.additional.amount_sanction,
    aadhaar_card_path:props.additional.aadhaar_card_path,
    aadhaar_card_file:props.additional.aadhaar_card_file,
    bank_passbook_path:props.additional.bank_passbook_path,
    bank_passbook_file:props.additional.bank_passbook_file,
    date_of_data_collection:props.additional.date_of_data_collection,
    remarks:'',
});
...
const addMore=()=>{
    if(form.scheme_id===''){
        ...
        // console.log(form.scheme_id.scheme_name);
        form.schemeApplied.push({
            schemes_id:form.scheme_id.id,
            scheme_name:form.scheme_id.scheme_name,
            availed:'Yes',
            amount:'',
        })
    }
...
const submit=()=>{
    ...
    form.put(route('additional-farmer-details.update',props.additional.id),{
        onStart:()=>{
            q.loading.show();
        },
        onSuccess:()=>{
