...
const form=useForm({
    id:props.hortiData.id,
    farmers_id:props.hortiData.farmers_id,
    farmer_horticulture_id:props.hortiData.farmer_horticulture_id,
    location:props.hortiData.location,
    kharif_crops_id:props.hortiData.farmer_horti_kharif_crops,
    kharif_total_area:props.hortiData.kharif_total_area,
    kharif_acres_or_hectares:'Acres',
    rabi_crops_id:props.hortiData.farmer_horti_rabi_crops,
    rabi_total_area:props.hortiData.rabi_total_area,
    rabi_acres_or_hectares:'Acres',
    orchards_id:props.hortiData.farmer_orchids,
    plantation_id:props.hortiData.farmer_plantation,
    green_house_id:props.hortiData.green_house_plants,
    total_greenhouse_area:props.hortiData.total_greenhouse_area,
});
